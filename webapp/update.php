	...
	<body><!-- 페이지 내용 -->
		...
		<main data-role="page" id="page2">
			<header data-role="header" data-position="fixed" data-theme="b">
                ...
                <nav data-role="navbar">
                    <ul>
                        ...
                        <li><a href="./select_all.php">조회</a></li> 
                    </ul>
                </nav>
			</header>
			...
			<article data-role="content">
                <h3>영화 정보 수정</h3>
				<form name="form2" method="POST" action="update_result.php" data-ajaxt="false">
